...
const queryClient = useQueryClient()
  const patientSchema = z.object({
    ...
    gender: z.enum(["male", "female"], {
      required_error: t("patients.genderRequired"),
    }),
  ...
  const updateMutation = useMutation({
    mutationFn: (data: PatientFormData) =>
      patientService.update(patient!.patient_id, data),
    onSuccess: () => {
    ...
    >
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <FormField
          ...
          required
          placeholder={t("patients.nationalIdRequired")}
        />
        <FormField
          name="birth_date"
        ...
        <FormField
          name="nationality"
          label={t("patients.nationality")}
          type="text"
          required
          placeholder={t("patients.nationalityRequired")}
        />
        <FormField
          name="gender"
        ...
        <FormField
          ...
          type="tel"
          required
          placeholder={t("patients.phoneRequired")}
        />
        <FormField
          name="mobile_number"
          label={t("patients.mobileNumber")}
          type="tel"
          placeholder={t("patients.mobileNumber")}
        />
        <FormField
          name="email"
      ...
      <FormField
        ...
        type="textarea"
        required
        placeholder={t("patients.addressRequired")}
      />
      <FormField
        name="notes"
