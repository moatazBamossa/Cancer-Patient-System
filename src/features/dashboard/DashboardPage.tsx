...
export default function DashboardPage() {
  ...
  const translateVisitType = (type: string) => {
    const mapping: Record<string, string> = {
      ...
      treatment_session: t("visits.visitTypeLabels.treatmentSession", {
  ...
  const stats = useMemo(() => {
    ...
    return [
      ...
      },
      {
        ...
        value:
          summary.cancer_stats?.total_cases ||
          summary.totals?.total_cancer_cases ||
          0,
      ...
      {
        label: t("dashboard.activeDiagnoses", {
          defaultValue: "Active Diagnoses",
        }),
  ...
  const quickActions = [
    {
      label: t("common.add") + " " + t("common.patient"),
      icon: Plus,
      path: "/patients",
      color: "#6366f1",
    },
    {
      label: t("common.diagnoses"),
      icon: Stethoscope,
      path: "/diagnoses",
      color: "#ec4899",
    },
  ...
  const monthlyTrendChart = useMemo(() => {
    ...
    return [...summary.monthly_trend].reverse().map((item: any) => ({
      ...
      <div className="flex flex-col items-center justify-center min-h-[400px] text-center glass-card p-8">
        ...
        >
          {t("dashboard.failedLoad", {
            defaultValue: "Failed to load dashboard summary",
          })}
        </h3>
        <p className="text-sm max-w-md" style={{ color: "var(--text-muted)" }}>
          {error?.message ||
            t("dashboard.failedLoadSubtitle", {
              defaultValue:
                "Please ensure database connections and permissions are configured correctly.",
            })}
        </p>
      </div>
    )
        ...
        <div className="space-y-2 relative z-10">
          ...
          >
            {t("dashboard.subtitle", {
              defaultValue:
                "Here is what is happening at the Cancer Center today.",
            })}
          </p>
          <div
          ...
          {[
            {
              label: t("dashboard.visitsToday", {
                defaultValue: "Visits Today",
              }),
              val: summary.today?.total_visits || 0,
              color: "text-indigo-500",
            },
            {
              label: t("dashboard.completed", { defaultValue: "Completed" }),
              val: summary.today?.completed_visits || 0,
              color: "text-emerald-500",
            },
            {
              label: t("dashboard.missed", { defaultValue: "Missed" }),
              val: summary.today?.missed_visits || 0,
              color: "text-rose-500",
            },
            {
              ...
              val: summary.today?.new_patients || 0,
              color: "text-amber-500",
            },
          ].map((act, i) => (
            <div
              key={i}
              className="p-3.5 rounded-2xl text-center min-w-[100px]"
        ...
        >
          <div className="flex items-center justify-between mb-6">
            ...
            >
              ...
              {t("dashboard.visitsTrend", {
                defaultValue: "Visits Monthly Trend",
              })}
            </h3>
          </div>
            ...
            {visitTypesChart.map((vt: any) => (
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  >
                   {visitTypeLabels[vt.name] ?? vt.name}
                  </span>
                </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        >
          ...
          >
            ...
            {t("dashboard.cancerByType", {
              defaultValue: "Cancer Cases by Type",
            })}
          </h3>
          <div className="overflow-x-auto">
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={summary.cancer_stats?.by_type || []} margin={{ bottom: 80, left: 0, right: 0, top: 10 }}>
                <defs>
        ...
        >
          <div className="space-y-4">
            ...
            >
              ...
              {t("dashboard.genderDemographics", {
                defaultValue: "Gender Split",
              })}
            </h3>
            {(() => {
              const male = summary.patient_demographics?.by_gender?.male || 0
              const female =
                summary.patient_demographics?.by_gender?.female || 0
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between text-xs font-semibold">
                      <span className="text-indigo-400">
                        {t("patients.male", { defaultValue: "Male" })} ({male})
                      </span>
          ...
          <div className="space-y-4">
            ...
            >
              ...
              {t("dashboard.ageDemographics", {
                defaultValue: "Age Distribution",
              })}
            </h3>
        ...
        >
          <div className="flex items-center justify-between mb-4">
            ...
            >
              ...
              {t("dashboard.doctorPerformance", {
                defaultValue: "Medical Staff Performance",
              })}
            </h3>
          </div>
          <table className="w-full text-sm text-left">
            <thead>
              ...
              >
                <th
                  className="pb-3 font-semibold text-xs uppercase tracking-wider"
                  style={{ color: "var(--text-muted)" }}
                >
                ...
                <th
                  className="pb-3 font-semibold text-xs uppercase tracking-wider text-center"
                  style={{ color: "var(--text-muted)" }}
                >
                  {t("dashboard.totalPatientsShort", {
            ...
            <tbody>
              {summary.doctor_performance?.map((doc: any) => {
                ...
                const attendancePct =
                  totalV > 0 ? Math.round((completedV / totalV) * 100) : 100
                return (
                  <tr
                    key={doc.doctor_id}
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3
                ...
                style={{ color: "var(--text-primary)" }}
              >
                {t("dashboard.missedFollowUp", {
                  defaultValue: "Visits Follow-up",
                })}
              </h3>
            </div>
            <p
              ...
              style={{ color: "var(--text-muted)" }}
            >
              {t("dashboard.missedFollowUpDesc", {
                defaultValue:
                  "These patients missed their appointments. Action required to contact or reschedule.",
              })}
            </p>
            ...
            <div className="space-y-3 max-h-[200px] overflow-y-auto pr-1">
                  ...
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <p
                        ...
                        style={{ color: "var(--text-muted)" }}
                      >
                        {t("common.doctor", { defaultValue: "Dr." })}{" "}
                        {visit.doctor_name}
                      </p>
                    </div>
                    <button
                      onClick={() =>
                        handleCopyEmail(visit.patient_email, visit.visit_id)
                      }
              ...
              {(!summary.missed_visits?.list ||
                summary.missed_visits.list.length === 0) && (
                <div
                ...
                >
                  ...
                  />
                  {t("dashboard.noMissedVisits", {
                    defaultValue: "All clean! No missed visits.",
                  })}
                </div>
              )}
            </div>
          ...
          >
            ...
            >
              {t("dashboard.viewAllUpcoming", {
                defaultValue: "View Upcoming Schedule",
              })}
